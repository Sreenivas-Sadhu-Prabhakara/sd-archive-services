package com.bank.bian.archiveservices.model;
...
/**
 * The BIAN control record for this service domain: "Archive Item Maintenance Agreement".
 *
 ...
 * to its asset type (Archive Item). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Archive Item Maintenance Agreement";
